...
BASE_DIR = frappe.get_app_path('jd_resume_matcher')
...
def get_download_url(filepath):
    ...
    # IMPORTANT: Use the CORRECT app name 'jd_resume_matcher' in the URL
    download_url = f"http://demo.localhost:8000/api/method/jd_resume_matcher.api.download_matched_resume?token={token}" # Corrected URL to relative path
    return download_url
...
def get_view_url(filepath):
    ...
    # IMPORTANT: Use the CORRECT app name 'jd_resume_matcher' in the URL for viewing
    view_url = f"http://demo.localhost:8000/api/method/jd_resume_matcher.api.view_matched_resume?token={token}" # Corrected URL to relative path
    return view_url
